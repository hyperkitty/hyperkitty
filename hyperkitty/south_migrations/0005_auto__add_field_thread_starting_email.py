...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Thread.starting_email'
        db.add_column(u'hyperkitty_thread', 'starting_email',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name=u'started_thread', unique=True, null=True, to=orm['hyperkitty.Email']),
                      keep_default=False)
        # Now populate the starting_email field
        if not db.dry_run:
    ...
    def backwards(self, orm):
        # Deleting field 'Thread.starting_email'
        db.delete_column(u'hyperkitty_thread', 'starting_email_id')
    ...
    models = {
        ...
        u'hyperkitty.thread': {
            ...
            'starting_email': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "u'started_thread'", 'unique': 'True', 'null': 'True', 'to': u"orm['hyperkitty.Email']"}),
