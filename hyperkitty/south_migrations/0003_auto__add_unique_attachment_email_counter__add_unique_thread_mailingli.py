...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Attachment', fields ['email', 'counter']
        db.create_unique(u'hyperkitty_attachment', ['email_id', 'counter'])

        # Adding unique constraint on 'Thread', fields ['mailinglist', 'thread_id']
        db.create_unique(u'hyperkitty_thread', ['mailinglist_id', 'thread_id'])

        # Adding unique constraint on 'Email', fields ['mailinglist', 'message_id']
        db.create_unique(u'hyperkitty_email', ['mailinglist_id', 'message_id'])

        # Adding unique constraint on 'Tag', fields ['name']
        db.create_unique(u'hyperkitty_tag', ['name'])

        # Adding unique constraint on 'Vote', fields ['email', 'user']
        db.create_unique(u'hyperkitty_vote', ['email_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Vote', fields ['email', 'user']
        db.delete_unique(u'hyperkitty_vote', ['email_id', 'user_id'])

        # Removing unique constraint on 'Tag', fields ['name']
        db.delete_unique(u'hyperkitty_tag', ['name'])

        # Removing unique constraint on 'Email', fields ['mailinglist', 'message_id']
        db.delete_unique(u'hyperkitty_email', ['mailinglist_id', 'message_id'])

        # Removing unique constraint on 'Thread', fields ['mailinglist', 'thread_id']
        db.delete_unique(u'hyperkitty_thread', ['mailinglist_id', 'thread_id'])

        # Removing unique constraint on 'Attachment', fields ['email', 'counter']
        db.delete_unique(u'hyperkitty_attachment', ['email_id', 'counter'])
